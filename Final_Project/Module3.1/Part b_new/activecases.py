...
def get_currently_infected():
    ...
    try:
        ...
        currently_infected = env['data'].split(',')
        del env['data']
        del env['date']
    except:
        currently_infected = 'N/A'
        dates = 'N/A'
    return dates, currently_infected

# Example Usage:
# dates, currently_infected = get_currently_infected()
# for i in range(0, len(dates)):
#     print(f'{dates[i]}\t{currently_infected[i]}')
